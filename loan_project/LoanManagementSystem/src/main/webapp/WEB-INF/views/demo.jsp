...
<body>
        ...
        <input type="number" id="custmobile" name="custmobile" required><br><br>
        ...
        <input type="number" id="custluser" name="custluser" required><br><br>
		</div>
		<div id="Nominee" class="tabcontent">
			<h3>Nominee</h3>
			 <label for="lnapid">Loan Applicant ID:</label>
        <input type="number" id="lnapid1" name="lnapid1" required><br><br>
		...
		<div id="LoanApplicant" class="tabcontent">
			<h3>LoanApplicant</h3>
			<label for="lnapid">Loan Applicant ID:</label>
        <input type="number" id="lnapid2" name="lnapid2" required><br><br>
        
        <label for="lnapcustid">Customer ID:</label>
        <input type="number" id="lnapcustid" name="lnapcustid" required><br><br>
        ...
        <input type="number" id="lnaplntyid" name="lnaplntyid" required><br><br>
        
        <label for="lnapamount">Loan Amount:</label>
        <input type="number" id="lnapamount" name="lnapamount" required><br><br>
        
        <label for="lnapemirangefrom">EMI Range From:</label>
        <input type="number" id="lnapemirangefrom" name="lnapemirangefrom" required><br><br>
        
        <label for="lnapemirangeto">EMI Range To:</label>
        <input type="number" id="lnapemirangeto" name="lnapemirangeto" required><br><br>
        
        <label for="lnapnomrequested">Nominee Requested Amount:</label>
        <input type="number" id="lnapnomrequested" name="lnapnomrequested" required><br><br>
        
        <label for="lnapcibilscore">CIBIL Score:</label>
        <input type="number" id="lnapcibilscore" name="lnapcibilscore" required><br><br>
        ...
        <input type="number" id="lnapprocesseduser" name="lnapprocesseduser" required><br><br>
